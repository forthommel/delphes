...
void ConvertInput(Long64_t eventCounter, Pythia8::Pythia *pythia,
  ...
  CandidatesCollection &allParticleOutputArray, CandidatesCollection &stableParticleOutputArray, CandidatesCollection &partonOutputArray,
...
int main(int argc, char *argv[])
{
  ...
  OutputHandle<CandidatesCollection> stableParticleOutputArray, allParticleOutputArray, partonOutputArray;
  OutputHandle<CandidatesCollection> stableParticleOutputArrayLHEF, allParticleOutputArrayLHEF, partonOutputArrayLHEF;
